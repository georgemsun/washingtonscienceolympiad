...
var page = function() {
	if($('.feature').html() != '')
		$('.page').css('height', $(window).innerHeight()*0.36);
	else
		$('.page').css('height', $(window).innerHeight()*0.28);
	$('.page h2').css('padding',$ (window).innerHeight()*0.13 + ' 0 ' + $(window).innerHeight()*0.01 + ' 0');
}
